#ifndef BALAS_FURIA_H_H
#define BALAS_FURIA_H_H
...
class BalasFuria : public Objetos {
private:
...
public:
  ...
  BalasFuria(std::string, sf::Vector2f, sf::Vector2f, float velocidad = 4.f,
             int valor = 25);
